# workflow_dreamshaper.json

Dockerized ComfyUI workflow: workflow_dreamshaper.json
...
docker build -t workflow_dreamshaper.json .

# Run the container
docker run -p 8188:8188 workflow_dreamshaper.json
```
